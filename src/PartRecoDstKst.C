...
PartRecoDstKst::PartRecoDstKst(RooRealVar* pmB, std::string m,std::string p, std::string c, std::string t, std::string a, std::string fileName)
{
  ...
  */
  ...
  pdf_g_001  = prs->pdf_Dst0Kst0_D0gamma_001[p];
  pdf_g_010  = prs->pdf_Dst0Kst0_D0gamma_010[p];
  pdf_pi_001 = prs->pdf_Dst0Kst0_D0pi0_001[p];
  pdf_pi_010 = prs->pdf_Dst0Kst0_D0pi0_010[p];
  // ------------------------------------
