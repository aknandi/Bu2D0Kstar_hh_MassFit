...
#include "TMath.h"
  ...
  shiftg("shiftg", "shiftg", this, _shiftg)
{
}


RooHORNSdini::RooHORNSdini(const RooHORNSdini& other, const char* name) :
  RooAbsPdf(other, name), m("m", this, other.m), a("a", this, other.a), b("b", this, other.b), csi("csi", this, other.csi), shift("shift", this, other.shift), sigma("sigma", this, other.sigma),  ratio_sigma("ratio_sigma", this, other.ratio_sigma), fraction_sigma("fraction_sigma", this, other.fraction_sigma), shiftg("shiftg", this, other.shiftg)
{
}
...
Double_t RooHORNSdini::evaluate() const 
{
  ...
  ///////////////////////////////////////////////////////////////////////
  double firstG2 = ((2*(a_new-2*B_NEW+(m-shift2))*sigma2)/exp((a_new-(m-shift2))*(a_new-(m-shift2))/(2*sigma2*sigma2)) - (2*(b_new-2*B_NEW+(m-shift2))*sigma2)/exp((b_new-(m-shift2))*(b_new-(m-shift2))/(2*sigma2*sigma2))+ sqrt(2*TMath::Pi())*((B_NEW-(m-shift2))*(B_NEW-(m-shift2)) + sigma2*sigma2)*TMath::Erf((-a_new+(m-shift2))/(sqrt(2)*sigma2))  - sqrt(2*TMath::Pi())*((B_NEW-(m-shift2))*(B_NEW-(m-shift2)) + sigma2*sigma2) * TMath::Erf((-b_new+(m-shift2))/(sqrt(2)*sigma2)))/(2*sqrt(2*TMath::Pi()));
  double secondG2 = (((2*sigma2*(a_new*a_new + B_NEW*B_NEW + a_new*(m-shift2) + (m-shift2)*(m-shift2) - 2*B_NEW*(a_new+(m-shift2)) + 2*(sigma2*sigma2)))/exp((a_new-(m-shift2))*(a_new-(m-shift2))/(2*(sigma2*sigma2))) - (2*sigma2*(b_new*b_new + B_NEW*B_NEW + b_new*(m-shift2) + (m-shift2)*(m-shift2) - 2*B_NEW*(b_new + (m-shift2)) + 2*(sigma2*sigma2)))/exp((b_new - (m-shift2))*(b_new - (m-shift2))/(2*(sigma2*sigma2))) - sqrt(2*TMath::Pi())*(-((B_NEW - (m-shift2))*(B_NEW - (m-shift2)) *(m-shift2)) + (2*B_NEW - 3*(m-shift2))*(sigma2*sigma2))*TMath::Erf((-a_new + (m-shift2))/(sqrt(2)*sigma2)) + sqrt(2*TMath::Pi())* (-((B_NEW - (m-shift2))*(B_NEW - (m-shift2))*(m-shift2)) + (2*B_NEW - 3*(m-shift2))*(sigma2*sigma2)) *TMath::Erf((-b_new + (m-shift2))/(sqrt(2)*sigma2)))/(2 *sqrt(2*TMath::Pi())));
