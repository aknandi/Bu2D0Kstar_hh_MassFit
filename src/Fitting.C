  ...
  if (doFit == "true")
    {
      ...
      int listindex = allPars.index("bu_mean_kpi");
      ...
      if (_genConfs->get("makeCorrelationMatrix")=="true")
        {
          ...
          if(true) {
        	  ...
        	  std::cout << "\\begin{tabular}{c|cccccccccccc} \n\\hline \n& $A_{K\\pi}$ & $A_{KK}$ & $A_{\\pi\\pi}$ & $R_{KK}$ & $R_{\\pi\\pi}$ & $R^+_{K\\pi}$ & $R^-_{K\\pi}$ & $A_{K\\pi\\pi\\pi}$ & $A_{\\pi\\pi\\pi\\pi}$ & $R_{\\pi\\pi\\pi\\pi}$ & $R^+_{K\\pi\\pi\\pi}$ & $R^-_{K\\pi\\pi\\pi}$ \\\\ \n \\hline" << std::endl;
        	  std::cout << "$A_{K\\pi}$ & " << result->correlation("A_d2kpi","A_d2kpi") << " & " << result->correlation("A_d2kpi","A_d2kk") << "  & " << result->correlation("A_d2kpi","A_d2pipi") << "  & " << result->correlation("A_d2kpi","R_d2kk") << "  & " << result->correlation("A_d2kpi","R_d2pipi") << "  & " << result->correlation("A_d2kpi","Rplus_d2pik") << "  & " << result->correlation("A_d2kpi","Rminus_d2pik") << "  & " << result->correlation("A_d2kpi","A_d2kpipipi") << "  & " << result->correlation("A_d2kpi","A_d2pipipipi") << "  & " << result->correlation("A_d2kpi","R_d2pipipipi") << "  & " << result->correlation("A_d2kpi","Rplus_d2pikpipi") << "  & " << result->correlation("A_d2kpi","Rminus_d2pikpipi") << "  \\\\" << std::endl;
        	  std::cout << "$A_{KK}$ & " << result->correlation("A_d2kk","A_d2kpi") << " & " << result->correlation("A_d2kk","A_d2kk") << "  & " << result->correlation("A_d2kk","A_d2pipi") << "  & " << result->correlation("A_d2kk","R_d2kk") << "  & " << result->correlation("A_d2kk","R_d2pipi") << "  & " << result->correlation("A_d2kk","Rplus_d2pik") << "  & " << result->correlation("A_d2kk","Rminus_d2pik") << "  & " << result->correlation("A_d2kk","A_d2kpipipi") << "  & " << result->correlation("A_d2kk","A_d2pipipipi") << "  & " << result->correlation("A_d2kk","R_d2pipipipi") << "  & " << result->correlation("A_d2kk","Rplus_d2pikpipi") << "  & " << result->correlation("A_d2kk","Rminus_d2pikpipi") << "  \\\\" << std::endl;
        	  std::cout << "$A_{\\pi\\pi}$ & " << result->correlation("A_d2pipi","A_d2kpi") << " & " << result->correlation("A_d2pipi","A_d2kk") << "  & " << result->correlation("A_d2pipi","A_d2pipi") << "  & " << result->correlation("A_d2pipi","R_d2kk") << "  & " << result->correlation("A_d2pipi","R_d2pipi") << "  & " << result->correlation("A_d2pipi","Rplus_d2pik") << "  & " << result->correlation("A_d2pipi","Rminus_d2pik") << "  & " << result->correlation("A_d2pipi","A_d2kpipipi") << "  & " << result->correlation("A_d2pipi","A_d2pipipipi") << "  & " << result->correlation("A_d2pipi","R_d2pipipipi") << "  & " << result->correlation("A_d2pipi","Rplus_d2pikpipi") << "  & " << result->correlation("A_d2pipi","Rminus_d2pikpipi") << "  \\\\" << std::endl;
        	  std::cout << "$R_{KK}$ & " << result->correlation("R_d2kk","A_d2kpi") << " & " << result->correlation("R_d2kk","A_d2kk") << "  & " << result->correlation("R_d2kk","A_d2pipi") << "  & " << result->correlation("R_d2kk","R_d2kk") << "  & " << result->correlation("R_d2kk","R_d2pipi") << "  & " << result->correlation("R_d2kk","Rplus_d2pik") << "  & " << result->correlation("R_d2kk","Rminus_d2pik") << "  & " << result->correlation("R_d2kk","A_d2kpipipi") << "  & " << result->correlation("R_d2kk","A_d2pipipipi") << "  & " << result->correlation("R_d2kk","R_d2pipipipi") << "  & " << result->correlation("R_d2kk","Rplus_d2pikpipi") << "  & " << result->correlation("R_d2kk","Rminus_d2pikpipi") << "  \\\\" << std::endl;
        	  std::cout << "$R_{\\pi\\pi}$ & " << result->correlation("R_d2pipi","A_d2kpi") << " & " << result->correlation("R_d2pipi","A_d2kk") << "  & " << result->correlation("R_d2pipi","A_d2pipi") << "  & " << result->correlation("R_d2pipi","R_d2kk") << "  & " << result->correlation("R_d2pipi","R_d2pipi") << "  & " << result->correlation("R_d2pipi","Rplus_d2pik") << "  & " << result->correlation("R_d2pipi","Rminus_d2pik") << "  & " << result->correlation("R_d2pipi","A_d2kpipipi") << "  & " << result->correlation("R_d2pipi","A_d2pipipipi") << "  & " << result->correlation("R_d2pipi","R_d2pipipipi") << "  & " << result->correlation("R_d2pipi","Rplus_d2pikpipi") << "  & " << result->correlation("R_d2pipi","Rminus_d2pikpipi") << "  \\\\" << std::endl;
        	  std::cout << "$R^+_{K\\pi}$ & " << result->correlation("Rplus_d2pik","A_d2kpi") << " & " << result->correlation("Rplus_d2pik","A_d2kk") << "  & " << result->correlation("Rplus_d2pik","A_d2pipi") << "  & " << result->correlation("Rplus_d2pik","R_d2kk") << "  & " << result->correlation("Rplus_d2pik","R_d2pipi") << "  & " << result->correlation("Rplus_d2pik","Rplus_d2pik") << "  & " << result->correlation("Rplus_d2pik","Rminus_d2pik") << "  & " << result->correlation("Rplus_d2pik","A_d2kpipipi") << "  & " << result->correlation("Rplus_d2pik","A_d2pipipipi") << "  & " << result->correlation("Rplus_d2pik","R_d2pipipipi") << "  & " << result->correlation("Rplus_d2pik","Rplus_d2pikpipi") << "  & " << result->correlation("Rplus_d2pik","Rminus_d2pikpipi") << "  \\\\" << std::endl;
        	  std::cout << "$R^-_{K\\pi}$ & " << result->correlation("Rminus_d2pik","A_d2kpi") << " & " << result->correlation("Rminus_d2pik","A_d2kk") << "  & " << result->correlation("Rminus_d2pik","A_d2pipi") << "  & " << result->correlation("Rminus_d2pik","R_d2kk") << "  & " << result->correlation("Rminus_d2pik","R_d2pipi") << "  & " << result->correlation("Rminus_d2pik","Rplus_d2pik") << "  & " << result->correlation("Rminus_d2pik","Rminus_d2pik") << "  & " << result->correlation("Rminus_d2pik","A_d2kpipipi") << "  & " << result->correlation("Rminus_d2pik","A_d2pipipipi") << "  & " << result->correlation("Rminus_d2pik","R_d2pipipipi") << "  & " << result->correlation("Rminus_d2pik","Rplus_d2pikpipi") << "  & " << result->correlation("Rminus_d2pik","Rminus_d2pikpipi") << "  \\\\" << std::endl;
        	  std::cout << "$A_{K\\pi\\pi\\pi}$ & " << result->correlation("A_d2kpipipi","A_d2kpi") << " & " << result->correlation("A_d2kpipipi","A_d2kk") << "  & " << result->correlation("A_d2kpipipi","A_d2pipi") << "  & " << result->correlation("A_d2kpipipi","R_d2kk") << "  & " << result->correlation("A_d2kpipipi","R_d2pipi") << "  & " << result->correlation("A_d2kpipipi","Rplus_d2pik") << "  & " << result->correlation("A_d2kpipipi","Rminus_d2pik") << "  & " << result->correlation("A_d2kpipipi","A_d2kpipipi") << "  & " << result->correlation("A_d2kpipipi","A_d2pipipipi") << "  & " << result->correlation("A_d2kpipipi","R_d2pipipipi") << "  & " << result->correlation("A_d2kpipipi","Rplus_d2pikpipi") << "  & " << result->correlation("A_d2kpipipi","Rminus_d2pikpipi") << "  \\\\" << std::endl;
           	  std::cout << "$A_{\\pi\\pi\\pi\\pi}$ & " << result->correlation("A_d2pipipipi","A_d2kpi") << " & " << result->correlation("A_d2pipipipi","A_d2kk") << "  & " << result->correlation("A_d2pipipipi","A_d2pipi") << "  & " << result->correlation("A_d2pipipipi","R_d2kk") << "  & " << result->correlation("A_d2pipipipi","R_d2pipi") << "  & " << result->correlation("A_d2pipipipi","Rplus_d2pik") << "  & " << result->correlation("A_d2pipipipi","Rminus_d2pik") << "  & " << result->correlation("A_d2pipipipi","A_d2kpipipi") << "  & " << result->correlation("A_d2pipipipi","A_d2pipipipi") << "  & " << result->correlation("A_d2pipipipi","R_d2pipipipi") << "  & " << result->correlation("A_d2pipipipi","Rplus_d2pikpipi") << "  & " << result->correlation("A_d2pipipipi","Rminus_d2pikpipi") << "  \\\\" << std::endl;
        	  std::cout << "$R_{\\pi\\pi\\pi\\pi}$ & " << result->correlation("R_d2pipipipi","A_d2kpi") << " & " << result->correlation("R_d2pipipipi","A_d2kk") << "  & " << result->correlation("R_d2pipipipi","A_d2pipi") << "  & " << result->correlation("R_d2pipipipi","R_d2kk") << "  & " << result->correlation("R_d2pipipipi","R_d2pipi") << "  & " << result->correlation("R_d2pipipipi","Rplus_d2pik") << "  & " << result->correlation("R_d2pipipipi","Rminus_d2pik") << "  & " << result->correlation("R_d2pipipipi","A_d2kpipipi") << "  & " << result->correlation("R_d2pipipipi","A_d2pipipipi") << "  & " << result->correlation("R_d2pipipipi","R_d2pipipipi") << "  & " << result->correlation("R_d2pipipipi","Rplus_d2pikpipi") << "  & " << result->correlation("R_d2pipipipi","Rminus_d2pikpipi") << "  \\\\" << std::endl;
        	  std::cout << "$R^+_{K\\pi\\pi\\pi}$ & " << result->correlation("Rplus_d2pikpipi","A_d2kpi") << " & " << result->correlation("Rplus_d2pikpipi","A_d2kk") << "  & " << result->correlation("Rplus_d2pikpipi","A_d2pipi") << "  & " << result->correlation("Rplus_d2pikpipi","R_d2kk") << "  & " << result->correlation("Rplus_d2pikpipi","R_d2pipi") << "  & " << result->correlation("Rplus_d2pikpipi","Rplus_d2pik") << "  & " << result->correlation("Rplus_d2pikpipi","Rminus_d2pik") << "  & " << result->correlation("Rplus_d2pikpipi","A_d2kpipipi") << "  & " << result->correlation("Rplus_d2pikpipi","A_d2pipipipi") << "  & " << result->correlation("Rplus_d2pikpipi","R_d2pipipipi") << "  & " << result->correlation("Rplus_d2pikpipi","Rplus_d2pikpipi") << "  & " << result->correlation("Rplus_d2pikpipi","Rminus_d2pikpipi") << "  \\\\" << std::endl;
        	  std::cout << "$R^-_{K\\pi\\pi\\pi}$ & " << result->correlation("Rminus_d2pikpipi","A_d2kpi") << " & " << result->correlation("Rminus_d2pikpipi","A_d2kk") << "  & " << result->correlation("Rminus_d2pikpipi","A_d2pipi") << "  & " << result->correlation("Rminus_d2pikpipi","R_d2kk") << "  & " << result->correlation("Rminus_d2pikpipi","R_d2pipi") << "  & " << result->correlation("Rminus_d2pikpipi","Rplus_d2pik") << "  & " << result->correlation("Rminus_d2pikpipi","Rminus_d2pik") << "  & " << result->correlation("Rminus_d2pikpipi","A_d2kpipipi") << "  & " << result->correlation("Rminus_d2pikpipi","A_d2pipipipi") << "  & " << result->correlation("Rminus_d2pikpipi","R_d2pipipipi") << "  & " << result->correlation("Rminus_d2pikpipi","Rplus_d2pikpipi") << "  & " << result->correlation("Rminus_d2pikpipi","Rminus_d2pikpipi") << "  \\\\" << std::endl;
