...
Double_t RooHILLdini::evaluate() const 
{
  ...
  ///////////////////
  double firstG2  = (2*exp(-((a_new-(m-shift2))*(a_new-(m-shift2))/(2*(sigma2*sigma2))))*sigma2*(b_new-(m-shift2))+2*exp(-((b_new-(m-shift2))*(b_new-(m-shift2))/(2*(sigma2*sigma2))))*sigma2*(-a_new+(m-shift2))-sqrt(2*TMath::Pi())*(a_new*b_new+(sigma2*sigma2)-(a_new+b_new)*(m-shift2)+((m-shift2)*(m-shift2)))*TMath::Erf((-a_new+(m-shift2))/(sqrt(2)*sigma2))+sqrt(2*TMath::Pi())*(a_new*b_new+(sigma2*sigma2)-(a_new+b_new)*(m-shift2)+((m-shift2)*(m-shift2)))*TMath::Erf((-b_new+(m-shift2))/(sqrt(2)*sigma2)))/(2*sqrt(2*TMath::Pi()));
